...
parser_flush_cbc (parser_context_t *context_p) /**< context */
{
  ...
  //   printf("parser_flush_cbc new context_p->byte_code.last_position %d\n",context_p->byte_code.last_position);
  //   printf("parser_flush_cbc new context_p->byte_code.last_p %#x\n",context_p->byte_code.last_p+context_p->byte_code.last_position);
  //   printf("parser_flush_cbc new context_p->byte_code.first_p %#x\n",context_p->byte_code.first_p);
  // }
  //
